            ...
            <div class="container py-5 prueba-footer">
                <div class="row mx-md-5 mx-5">
                    ...
                    <div class="col-md-3 mb-3">
                        <p class="text-white footer-izq">Menú</p>
                    ...
                    <div class="col-md-5 mb-3">
                        <p class="text-white footer-cen">Contáctanos</p>
                        ...
                        <p class="text-white mt-4 footer-subtext d-none d-md-block">
                            InnoVenta                        
                        </p>
                        <p class="footer-text">
                    ...
                    <div class="col-md-4 col-12 mb-3">
                        <p class="text-white footer-cen">Suscríbete</p>
                        <p class="text-white footer-der">Suscríbete para recibir notificaciones</p>
                        <form class="">
