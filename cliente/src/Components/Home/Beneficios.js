        ...
        <div class="innoventa-container" id='beneficios'>
            ...
            <div class="innoventa-cards-container row">
                <div class="innoventa-card col-12">
                    <CloudImage publicId="Vector_atfcj7" className="innoventa-card-image"/>
                ...
                <div class="innoventa-card col-12">
                    <CloudImage publicId="Vector2_iwhak7" className="innoventa-card-image"/>
                ...
                <div class="innoventa-card col-12">
                <CloudImage publicId="Vector3_yzotuk" className="innoventa-card-image"/>
